...
Il y a `r nrow(T0relation_sans_NA[T0relation_sans_NA$durée != 0,])` relations ou la durée est nulle. Les autres cas sont representé par la figure \@ref(fig:durremodalite).
...
plot_ly(T0relation_sans_NA, y = ~durée, color = ~modaNiv1, type = "box",
...
Pour les points suivants je n'ai pas gardé les `hiérarchique asc. Ecole` ni les `hiérarchique ascendante` car elles doublonnait avec leur vis à vis descendantes. On obtient `r comps$no` composantes connexes.
