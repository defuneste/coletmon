...
La figure \@ref(fig:date-modalite) regroupe les relations par un pas de temps de 100 ans pour les trois modalités : hiérarchique descendante, Relation horizontale et hiérarchique desc. Ecole. 

(ref:date-modalite) Répartition des dates de début par tranches de 100 ans en fonction des modes d'agrégation 

```{r, date-modalite, fig.cap="(ref:date-modalite)", fig.align='center', warning=FALSE}
